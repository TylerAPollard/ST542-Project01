...
shinyUI(
  dashboardPage(dark = FALSE, footer = dashboardFooter(left = br()), freshTheme = my_theme,
                ...
                sidebar = dashboardSidebar(
                  ...
                  sidebarMenu(
                    id = "menu_items",
                    menuItem(text = "Home", tabName = "home", icon = icon("home"), selected = TRUE),
                    menuItem(text = "S-STEM", icon = icon("square-poll-vertical"), expandedName = "SSTEM_Tab", startExpanded = FALSE,
                             menuSubItem(text = "Data", tabName = "SSTEM_Data_tab", icon = icon("database")),
                ...
                body = dashboardBody(
                  tabItems(
                    ...
                    ## S-STEM DATA Tab =================
                    tabItem(
                      tabName = "SSTEM_Data_tab",
                      h2(strong("S-STEM Survey Data")),
                      fluidPage(
                        ...
                        fluidRow(
                          ...
                          column(
                            width = 3,
                            box(title = div(h4(strong("Data Inputs"), 
                                ...
                                #### Datasets ----
                                uiOutput(outputId = "SSTEM_loadedDatasets_ui"),
                          ...
                          column(
                            ...
                            tabBox(
                              ...
                              tabPanel(
                                ...
                                fluidPage(
                                  h2("Preview"),
                                  dataTableOutput(outputId = "newSSTEMdata_ui")
                                )
                              ),
                              tabPanel(
                                title = "View"
                          ...
                          fluidPage(
                            ...
                            fluidRow(
                              column(
                                ...
                                #### Inputs ----
                                box(title = div(h4(strong("Model Inputs"), 
                                                   style = "display: inline-block;
                                                            vertical-align: top")),
                                    solidHeader = TRUE, collapsible = TRUE, collapsed = FALSE, status = "primary",
                                    width = 12,
